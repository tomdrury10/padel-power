...
const GUIDES = [
  ...
  },
  {
    ...
    intro: 'This is different from cancelling. Cancelling removes one date. This removes the slot from every week from now on.',
    steps: [
    ...
    notes: [
      'Bookings already taken for upcoming dates are NOT cancelled and those members are NOT told.',
      'So if anyone is booked onto future dates, cancel those dates first, one by one, then remove the series.',
